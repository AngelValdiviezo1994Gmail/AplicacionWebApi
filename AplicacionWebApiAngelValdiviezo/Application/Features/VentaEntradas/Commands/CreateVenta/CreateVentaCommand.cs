...
namespace Application.Features.VentaEntradas.Commands.CreateVenta
{
    ...
    public class CreateClienteCommandHandler : IRequestHandler<CreateClienteCommand, ResponseType<string>>
    {
        ...
        public CreateClienteCommandHandler(IRepositoryAsync<FamiliarColaborador> repositoryFamiCol, 
            IRepositoryAsync<Cliente> repository, IRepositoryAsync<Prospecto> repoProspAsync, IApisConsumoAsync repositoryApis,
