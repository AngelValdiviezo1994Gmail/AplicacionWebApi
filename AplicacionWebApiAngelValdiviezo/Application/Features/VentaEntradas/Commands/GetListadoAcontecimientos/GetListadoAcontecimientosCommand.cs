...
namespace Application.Features.VentaEntradas.Commands.GetListadoAcontecimientos
{
    ...
    public class GetListadoAcontecimientosCommandHandler : IRequestHandler<GetListadoAcontecimientosCommand, ResponseType<List<ListadoAcontecimientosType>>>
    {
        ...
        public GetListadoAcontecimientosCommandHandler(IRepositoryAsync<Cliente> repository, IRepositoryAsync<Localidad> repositoryAsyncLoc,
        ...
        public async Task<ResponseType<List<ListadoAcontecimientosType>>> Handle(GetListadoAcontecimientosCommand request, CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                if (lstCola.Count == 0) return new ResponseType<List<ListadoAcontecimientosType>>() { Data = listadoColaboradores, Message = CodeMessageResponse.GetMessageByCode("001"), StatusCode = "001", Succeeded = false };
                ...
                foreach (var item in lstCola)
                {
                    ...
                    listadoColaboradores.Add(new ListadoAcontecimientosType()
                    {
                        Id = item.Id,
